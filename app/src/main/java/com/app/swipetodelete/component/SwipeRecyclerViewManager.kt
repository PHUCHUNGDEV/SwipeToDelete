...
class SwipeRecyclerViewManager : ItemTouchHelper.SimpleCallback {
    //------------Standard Values------------
    ...
    private fun initWithStandardValues() {
        ...
        this.leftBackgroundColor = ColorDrawable(STANDARD_COLOUR)
        this.rightBackgroundColor = ColorDrawable(STANDARD_COLOUR)
    ...
    /**
     * Used to implement different  Swipe actions in [SwipeRecyclerViewManager]
     */
